...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "CSE","SWE","ECE"};
	private String[] yearString = new String[] {"SE","TE","FE",""};
	private String[] subjectSEString = new String[] {"MAD","OS","DSA"};
	private String[] subjectTEString = new String[] {"ECE","DBMS"};
	private String[] subjectBEString = new String[] {"FCN","O.O.A.D"};

	private String[] subjectFinal = new String[] {"SWE","DSA","MAD","FCN","DBMS","OS","OOAD","ECE"};
